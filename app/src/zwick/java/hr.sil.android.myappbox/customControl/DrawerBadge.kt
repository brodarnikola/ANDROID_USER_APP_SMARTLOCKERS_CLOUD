package hr.sil.android.myappbox.customControl
...
import hr.sil.android.smartlockers.enduser.fonts.AppFonts


class DrawerBadge : AppCompatTextView {
    ...
    init {
        circlePaint = Paint()
        circlePaint?.color = ContextCompat.getColor(context, R.color.colorRedBadgeNumber)
