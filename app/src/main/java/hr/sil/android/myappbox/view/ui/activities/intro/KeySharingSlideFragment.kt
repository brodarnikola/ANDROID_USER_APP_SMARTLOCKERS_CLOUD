...
class KeySharingSlideFragment : Fragment() {

//    private lateinit var binding: FragmentIntroductionKeySharingBinding
//
//    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
//        val view = inflater.inflate(R.layout.fragment_introduction_key_sharing, container, false)
//
//        binding = FragmentIntroductionKeySharingBinding.inflate(inflater)
//
//        return view
//    }
//
...
//            val startIntent = Intent(this@KeySharingSlideFragment.activity, startupClass)
//            startIntent.putExtra("SPLASH_START", false)
//            startActivity(startIntent)
//            this@KeySharingSlideFragment.activity?.finish()
//        }
//    }
}