...
/** Remembers and creates an instance of [SunbirdAppState] */
...
/** Responsible for holding state related to [SunbirdApp] and containing UI-related logic. */
@Stable
