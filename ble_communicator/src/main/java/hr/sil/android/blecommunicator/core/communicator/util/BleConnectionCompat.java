package hr.sil.android.blecommunicator.core.communicator.util;
 ...
 *
 * @author Apache License 2.0 Copyright 2016 Polidea Sp. z o.o
 */
public class BleConnectionCompat {
    ...
    private BluetoothGatt connectGattCompat(BluetoothGattCallback bluetoothGattCallback, BluetoothDevice device, boolean autoConnect) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            return device.connectGatt(context, autoConnect, bluetoothGattCallback, android.bluetooth.BluetoothDevice.TRANSPORT_LE);
        } else {
    ...
    private BluetoothGatt createBluetoothGatt(Object iBluetoothGatt, BluetoothDevice remoteDevice)
        ...
        if (bluetoothGattConstructor.getParameterTypes().length == 4) {
            return (BluetoothGatt) (bluetoothGattConstructor.newInstance(context, iBluetoothGatt, remoteDevice, android.bluetooth.BluetoothDevice.TRANSPORT_LE));
        } else {
